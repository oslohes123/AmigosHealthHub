...
test.serial('getWorkoutFrequency returns error when userid is missing', async (t: ExecutionContext) => {
...
test.serial('getWorkoutFrequency with user with no workouts results in success and empty arrays', async (t: ExecutionContext) => {
...
test.serial('getWorkoutFrequency with user with 1 workout returns array of size 1', async (t: ExecutionContext) => {
...
test.serial('getWorkoutFrequency with user with 2 workouts returns correct graph labels and data', async (t: ExecutionContext) => {
