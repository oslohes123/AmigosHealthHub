...
test("Return last 7 words and their frequencies", async (t: any) => {
    ...
    console.log("In returning last 7 words and their frequencies with already inputted ID")
    const req = mockRequest({
        id: 'e9a8a99d-1852-4c2d-802c-e10d3ebdc05b',
    });
    const res = mockResponse();
...
// })
test("Return last 7 words and their frequencies with new ID", async (t: any) => {
