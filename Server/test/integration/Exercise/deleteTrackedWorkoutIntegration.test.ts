...
test('deleteTrackedWorkout route is correct', (t: any) => {
...
test(`DELETE ${deleteTrackedWorkoutRoute} results in error when userid is missing`, async (t: any) => {
...
test(`DELETE ${deleteTrackedWorkoutRoute} results in error when workoutname is missing`, async (t: any) => {
  const invalidRequest = cloneDeep(validRequest)
...
test(`DELETE ${deleteTrackedWorkoutRoute} results in error when date is missing`, async (t: any) => {
  const invalidRequest = cloneDeep(validRequest)
...
test(`DELETE ${deleteTrackedWorkoutRoute} results in error when time is missing`, async (t: any) => {
  const invalidRequest = cloneDeep(validRequest)
...
test.serial(`DELETE ${deleteTrackedWorkoutRoute} results in error when user has no completed workouts`, async (t: any) => {
...
test.serial(`DELETE ${deleteTrackedWorkoutRoute} results in success when given correct workout details`, async (t: any) => {
...
test.serial(`DELETE ${deleteTrackedWorkoutRoute} results in error when user has workout of the same name but at a different given time/date`, async (t: any) => {
  const nameOfWorkout = validRequest.workoutname
