...
test.serial('getAllExercises route is correct', (t: any) => {
  t.true(getAllExercisesRoute === '/api/user/exercise/getAll')
})
test.serial(`GET ${getAllExercisesRoute} results in error when userid is missing`, async (t: any) => {
...
test.serial(`GET ${getAllExercisesRoute} results in empty arrayOfExerciseNames when userid has no completed workouts`, async (t: any) => {
  const response = await request(app)
    .get(getAllExercisesRoute)
...
test.serial(`GET ${getAllExercisesRoute} results in populated arrayOfExerciseNames when userid has completed workouts`, async (t: any) => {
