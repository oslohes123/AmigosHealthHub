...
export const wordValues = async(req:Request,res:Response) => {
    ...
    let words: any
        ...
        return res.status(200).json({mssg: "Retrieved words", words:words, success: "successful"}) 
    }
...
export const faceValues = async(req:Request,res:Response) =>{
    ...
    return res.status(200).json({mssg: "Retrieved words", faces:faces, success: "successful"}) 
}
