...
export default function widget({iconName = 'chevron-forward-outline', widgetText = "Widget Title", fontSize = 16, height = 30, width = 50, buttonFunction, widgetColor = "yellow"}) {
    const styles = {
        textData: {
          fontSize: fontSize,
          color: 'white',
