...
export default function CreateNewWorkoutScreen({ navigation, route }) {
  ...
  useEffect(() => {
    ...
    console.log(
      `selected exercises after: ${JSON.stringify(selectedExercises)}`
    );
  }, [route.params]);
  ...
  return (
    ...
    >
      ...
      >
        Could not save workout plan. Make sure at least 1 exercise has been
        selected and you have given the plan a name.
      </Snackbar>
